    ...
    <div class="about__inner inner">
      ...
      <div class="about__img-wrap">
        <div class="about__img-small">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/about-us1.jpg" alt="水中にいるダイバーの様子">
        </div>
        <div class="about__img-big">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/about-us2.jpg" alt="水中にいるダイバーの様子">
        </div>
      </div>
    ...
    <div class="information__inner inner">
      ...
      <div class="information__content">
        <div class="information__img colorbox">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/information.jpg" class="information__img-img" alt="複数の魚が水中でサンゴの近くを泳いでいる様子">
        </div>
  ...
  <section id="price" class="price top-price">
    <div class="price__inner inner">
      ...
      <div class="price__imgTop">
        <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/price1.jpg" alt="水中のウミガメの様子">
      </div>
      <div class="price__content">
        ...
        <div class="price__imageCenter colorbox">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/price2.jpg" class="price__imageCenter-img" alt="水中のサンゴと複数の小魚の様子">
        </div>
      </div><!-- price__content -->

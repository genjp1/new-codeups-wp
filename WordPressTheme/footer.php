      ...
      <div class="contact__content">
        <div class="contact__left">
          <div class="contact__imgTop">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/contact-logo.svg" alt="CodeUps">
          </div>
      ...
      <div class="footer__icon">
        <div class="footer__logo">
          <a href="<?php echo $home; ?>" class="logo logo--footer">
            <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/footer-logo.svg" alt="CodeUps">
          </a>
        </div>
        <div class="footer__sns footer-sns">
          <ul class="footer-sns__items">
            <li class="footer-sns__item"><a href="https://www.facebook.com/" target="_blank"><img
                  img src="<?php echo get_template_directory_uri() ?>/assets/images/common/footer-facebook.svg" alt="facebook"></a></li>
            <li class="footer-sns__item"><a href="https://www.instagram.com/" target="_blank"><img
                  img src="<?php echo get_template_directory_uri() ?>/assets/images/common/footer-instagram.svg" alt="instagram"></a></li>
          </ul>
        </div>
      </div>

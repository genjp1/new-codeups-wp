  ...
  <section class="sub-mv">
    <div class="sub-mv__inner">
      <div class="sub-mv__title-wrap">
        <h1 class="sub-mv__main-title">Information</h1>
      </div>
      <div class="sub-mv__img">
        <picture>
          <source media="(min-width: 768px)" srcset="<?php echo get_template_directory_uri() ?>/assets/images/common/mv-information.jpg" class="sub-m__img-pc">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/mv-information-sp.jpg" class="sub-m__img-sp" alt="水中でダイバーが崖沿い魚と泳いでいる様子">
        </picture>
      </div>
    </div>
  </section>
  ...
  <section class="page-information top-page-information">
    <div class="page-information__inner inner">
      ...
      <div class="page-information__tab tab">
        <div class="tab__list">
          <button
            class="tab__button tab__button--licence js-tab-button is-active">ライセンス<br
              ...
              <li class="information-cards__card information-card">
                <div class="information-card__content">
                  ...
                  <div class="information-card__img colorbox">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/page-information1.jpg" alt="5人のダイバーが水面に浮かんでいる様子"
            ...
            <ul class="tab__cards information-cards">
              <li class="information-cards__card information-card">
                <div class="information-card__content">
                  ...
                  <div class="information-card__img colorbox">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/page-information2.jpg" alt="水中で多くの魚が泳いている様子"
                      class="information-card__img-img">
                  </div>
                </div>
              </li>
            ...
            <ul class="tab__cards information-cards">
              <li class="information-cards__card information-card">
                <div class="information-card__content">
                  ...
                  <div class="information-card__img colorbox">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/page-information3.jpg" alt="水中で2匹の魚が寄り添って泳いでいる様子"
                      class="information-card__img-img">
                  </div>
                </div>
              </li>

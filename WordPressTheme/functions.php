...
// 	wp_enqueue_script( 'jquery.inview.min.js', get_template_directory_uri() . 'assets/js/jquery.inview.min.js', array( 'jquery' ), '1.0.1', true );
...
function add_custom_scripts() {
    ...
    //gsapのJSの追加
    wp_enqueue_script( 'gsap', '//cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js', array( 'jquery' ), '3.12.2', true );

    //jquery.inview.minのJSの追加
    wp_enqueue_script( 'jquery.inview.min.js', get_template_directory_uri() . '/assets/js/jquery.inview.min.js', array( 'jquery' ), '1.0.1', true );

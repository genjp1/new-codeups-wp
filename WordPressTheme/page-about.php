  ...
  <section class="sub-mv">
    <div class="sub-mv__inner">
      <div class="sub-mv__title-wrap">
        <h1 class="sub-mv__main-title">About us</h1>
      </div>
      <div class="sub-mv__img">
        <picture>
          <source media="(min-width: 768px)" srcset="<?php echo get_template_directory_uri() ?>/assets/images/common/mv-about.jpg" class="sub-mv__img-pc">
          <img src="<?php echo get_template_directory_uri() ?>/assets/images/common/mv-about-sp.jpg" class="sub-m__img-sp" alt="5人のダイバーが水面に浮かんでいる様子">
        </picture>
      </div>
    </div>
  </section>
